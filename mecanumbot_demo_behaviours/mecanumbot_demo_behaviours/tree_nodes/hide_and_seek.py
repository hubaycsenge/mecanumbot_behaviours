...
from mecanumbot_demo_behaviours.behaviours.movement_managers import ProcessDetections, GetNextWaypoint
from mecanumbot_demo_behaviours.behaviours.blackboard_managers import MapWaypointsToBlackboard
def create_tree():
...
def main():
    ...
    ros_tree = py_trees_ros.trees.BehaviourTree(
        root=tree,
